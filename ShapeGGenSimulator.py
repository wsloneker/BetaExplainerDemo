...
def return_ShapeGGen_dataset(data):
    if data == 'base':
        seed = 1
        set_seed(seed)
        Gr = ShapeGGen(shape = 'house', num_subgraphs = 1200, prob_connection = 0.006, subgraph_size = 11, n_features = 11, n_informative = 4, class_sep = 0.6, n_clusters_per_class = 2, sens_attribution_noise = 0.5, homophily_coef = 1)
    elif data == 'hetero':
        seed = 1
        set_seed(seed)
        Gr = ShapeGGen(shape = 'house', num_subgraphs = 1200, prob_connection = 0.006, subgraph_size = 11, n_features = 11, n_informative = 4, class_sep = 0.6, n_clusters_per_class = 2, sens_attribution_noise = 0.5, homophily_coef = -1)
        ...
        seed = 4
        set_seed(seed)
        Gr = ShapeGGen(shape = 'house', num_subgraphs = 1200, prob_connection = 0.006, subgraph_size = 11, n_features = 11, n_informative = 4, class_sep = 0.6, n_clusters_per_class = 2, sens_attribution_noise = 0.75, homophily_coef = 1)
    elif data == 'moreinform':
        seed = 400
        set_seed(seed)
        Gr = ShapeGGen(shape = 'house', num_subgraphs = 1200, prob_connection = 0.006, subgraph_size = 11, n_features = 11, n_informative = 8, class_sep = 0.6, n_clusters_per_class = 2, sens_attribution_noise = 0.5, homophily_coef = 1)
        lr = 0.05
        wd = 0.001
